...
import { IThresholdComputationService, ThresholdResult } from './threshold.interfaces';
...
export class ThresholdComputationService implements IThresholdComputationService {
  ...
  computeThreshold(driveSnapshot: DriveSnapshot): ThresholdResult {
    ...
    // Each drive is normalized to [0,1] relative to its activation range
    ...
    // Log the computation breakdown at debug level
    this.logger.debug(

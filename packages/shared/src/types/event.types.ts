...
export const EVENT_BOUNDARY_MAP = {
  ...
  RUMINATION_BREAKER_TRIPPED: 'DECISION_MAKING',
  // Communication
  ...
  GUARDIAN_TEACHING_DETECTED: 'COMMUNICATION',
  // Learning
  ...
  REFLECTION_CYCLE_STARTED: 'LEARNING',
  REFLECTION_CYCLE_COMPLETED: 'LEARNING',
  REFLECTION_INSIGHT_CREATED: 'LEARNING',
  // Drive Engine

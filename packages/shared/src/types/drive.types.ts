...
export interface PressureVector {
  ...
  readonly [DriveName.Focus]: number;
 ...
 *
 * Total initial pressure: 2.4 (20.0% of max 12.0). Curiosity (0.3) and
 ...
 * Focus begins at zero — event-only drive (like Guilt), spikes on prediction

...
4. **WS3** — compounding memory. **NOW IN PROGRESS (2026-06-13)** — verification reframed it as the next curve-mover: close the knowledge use→reinforce edge (`wiki/ws3-build-plan.md`). (Supersedes the earlier "WS3 / WS5 later" note: WS3 is next; WS5 grounding payoff stays staged after the loop is proven.)
5. **WS5** — grounding payoff *(later)*.
